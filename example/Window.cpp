...
Window::Window() {
   ...
   skyplotWidget->insert(2, 40, 15, QString("2"), Qt::red, Qt::yellow,
                         fontColor,
                         SkyplotWidget::SatelliteState::Visible |
                             SkyplotWidget::SatelliteState::Marked

   );
   skyplotWidget->insert(3, 80, 15, QString("3"), Qt::red, Qt::yellow,
                         fontColor,
                         SkyplotWidget::SatelliteState::HalfVisible |
                             SkyplotWidget::SatelliteState::Marked);

   skyplotWidget->insert(4, 120, 15, QString("4"), Qt::red, Qt::white,
                         fontColor,
                         SkyplotWidget::SatelliteState::Visible |
                             SkyplotWidget::SatelliteState::Marked |
                             SkyplotWidget::SatelliteState::Flashing);
   skyplotWidget->insert(5, 150, 15, QString("5"), Qt::red, Qt::white,
                         fontColor,
                         SkyplotWidget::SatelliteState::HalfVisible |
                             SkyplotWidget::SatelliteState::Marked |
                             SkyplotWidget::SatelliteState::Flashing);
   ...
   for (int i = 50; i <= 70; i++) {
      skyplotWidget->insert(i, 0, 0, QString("0" + QString::number(i)),
                            Qt::magenta, Qt::white, fontColor,
                            SkyplotWidget::SatelliteState::Visible);
      ...
      skyplotWidget->setState(i, SkyplotWidget::SatelliteState::Visible |
                                     SkyplotWidget::SatelliteState::Marked);
